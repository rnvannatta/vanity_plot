OBJS := main.o vanity_graphics.o vert.o frag.o volk.o
...
main.exe.o main.o : vanity_graphics_private.h volk.h vert.h frag.h vector_math.h
...
.PHONY: clean
clean:
	rm -f a.out a.exe $(OBJS) $(WIN_OBJS) vert.spv frag.spv vert.h frag.h
